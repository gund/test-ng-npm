...
const buildUmdMin = `${UGLIFYJS} -c --screw-ie8 --comments -o dist/bundles/test-ng-npm.umd.min.js dist/bundles/test-ng-npm.umd.js`
...
function moveFesmEs5() {
  fs.renameSync('dist/bundles/es5/test-ng-npm.es2015.js', 'dist/bundles/test-ng-npm.es5.js')
}
